...
import com.linqi.userservice.common.beans.LogType;
import com.linqi.userservice.common.beans.PageQuery;
import com.linqi.userservice.common.beans.PageResult;
import com.linqi.userservice.common.enums.LogResultEnum;
...
import com.linqi.userservice.dao.*;
import com.linqi.userservice.dto.SearchLogDto;
import com.linqi.userservice.model.*;
...
public class SysLogService {
        ...
        switch (sysLog.getType()){
            case LogType.TYPE_DEPT:
                ...
                if (StringUtils.isBlank(sysLog.getNewValue())  || StringUtils.isBlank(sysLog.getOldValue())) {
                    throw new ParamException(LogResultEnum.CREATE_DELETE_NOT_RESET);
                }
            ...
            case LogType.TYPE_ROLE_ACL:
                ...
                sysRoleAclService.changeRoleAcls(sysLog.getTargetId(), JSON.parseArray(sysLog.getOldValue(),Integer.class));
                break;
            case LogType.TYPE_ROLE_USER:
                SysRole userRole = sysRoleMapper.selectByPrimaryKey(sysLog.getTargetId());
                Preconditions.checkNotNull(userRole, "角色已经不存在了");
                sysRoleUserService.changeRoleUsers(sysLog.getTargetId(), JSON.parseArray(sysLog.getOldValue(),Integer.class));
                break;
            default:;
        }
    }
    ...
    public PageResult<SysLogWithBLOBs> searchPageList(SearchLogParam param, PageQuery page) {
        ...
        try {
            ...
            throw new ParamException(LogResultEnum.HAS_SAME_CHILD_ACL);
        }
    ...
    public void saveDeptLog(SysDept before, SysDept after) {
        ...
        // sysLog.setOperator(RequestHolder.getCurrentUser().getUsername()); // TODO: 2019/8/11 暂时拿不到Request信息
